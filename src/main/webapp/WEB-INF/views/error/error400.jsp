...
<body class="404 sidebar-collapse" style="align-items:center">
<!-- Navbar -->

<!-- End Navbar -->
<div class="background-img" style="background-image: url('${pageContext.request.contextPath}/resources/assets/img/korea/knock.jpg')">
    ...
    <div class="container" style="height:100%">
        ...
        <div class="row">
            ...
            <h2 class="title"> &nbsp;400
                <br/>
                <p class="error-msg">권한이 충분하지 않습니다!</p>
            </h2>
        </div>
        ...
        <div class="container-cards">
            <div class="row">
                <h5 class="discover-pages text-center"><a href="http://localhost:8080/">돌아가기</a></h5></a>
                <br/>
                <br/>
                <br/>
            </div>
...
<!--  Vertical nav - dots -->
<!--  Photoswipe files -->
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/photo_swipe/photoswipe.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/photo_swipe/photoswipe-ui-default.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/photo_swipe/init-gallery.js"></script>
<!--  for Jasny fileupload -->
<script src="${pageContext.request.contextPath}/resources/assets/js/plugins/jasny-bootstrap.min.js"></script>
